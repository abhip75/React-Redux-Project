...
const Home = () => {
    ...
    return(
        <Container>
            ...
            <Section title="Solar for New Roofs" description="Solar Roof cost Less Than a New Roof Plus Solar Panels" backgroundImg="solar-roof.jpg" leftBtnText="Order now" rightBtnText="Learn more"/>
